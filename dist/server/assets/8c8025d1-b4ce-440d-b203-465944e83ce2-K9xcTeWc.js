...
function IndexPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-6xl mx-auto px-4 py-6 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4 shadow-[var(--shadow-soft)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: add, className: "grid grid-cols-1 md:grid-cols-[140px_1fr_1fr_130px_auto] gap-3 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "ticket", className: "text-xs", children: "Ticket" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "ticket", value: ticket, onChange: (e) => setTicket(e.target.value), placeholder: "opcional", className: "h-10" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "numero", className: "text-xs", children: "Número *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "numero", required: true, value: numero, onChange: (e) => setNumero(e.target.value), placeholder: "ex: 30534-83996952205", className: "h-10" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "atend", className: "text-xs", children: "Atendimento" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "atend", value: atendimento, onChange: (e) => setAtendimento(e.target.value), placeholder: "ex: encaminhado para s2", className: "h-10" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { type: "submit", disabled: busy, className: "h-10 mt-5", children: [
