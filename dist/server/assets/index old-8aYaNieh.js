...
function IndexPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-6xl mx-auto px-4 py-6 space-y-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 shadow-[var(--shadow-soft)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 grid grid-cols-[140px_1fr_1fr_130px_auto] gap-3 hidden md:grid", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Ticket" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Número *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Atendimento" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Canal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: add, className: "grid grid-cols-1 md:grid-cols-[140px_1fr_1fr_130px_auto] gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden mb-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Ticket" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: ticket, onChange: (e) => setTicket(e.target.value), placeholder: "opcional" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden mb-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Número *" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { required: true, value: numero, onChange: (e) => setNumero(e.target.value), placeholder: "ex: 30534-83996952205" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden mb-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Atendimento" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: atendimento, onChange: (e) => setAtendimento(e.target.value), placeholder: "ex: encaminhado para s2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden mb-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Canal" }) }),
